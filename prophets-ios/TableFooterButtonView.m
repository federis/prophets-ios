...
@implementation TableFooterButtonView

+(TableFooterButtonView *)footerButtonViewForTable:(UITableView *)tableView withText:(NSString *)text{
    CGRect frame = CGRectMake(0, 0, tableView.frame.size.width, 50);
    TableFooterButtonView *view = [[TableFooterButtonView alloc] initWithFrame:frame];
